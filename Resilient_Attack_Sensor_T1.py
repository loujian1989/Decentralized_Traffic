#!/usr/bin/env python
"""
@file    Resillient_Attack_Sensor_T1.py
@author  Jian Lou
version 2
"""
...
f = open("Resilient_Attack_Sensor_T1(Weight2).txt", "a")
...
if __name__ == "__main__":
    ...
    s_NS_FH=5 
    s_WE_FH=8 #the threshold of North-South and West-East direction for intersection FH

    s_NS_AC=4
    s_WE_AC=8 #the threshold of North-South and West-East direction for intersection IK
    
    Weight = 2 #the weight of firetrucks, it can be changed
