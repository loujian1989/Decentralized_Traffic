...
def run(s_NS_IK, s_WE_IK, s_NS_LJ, s_WE_LJ, s_NS_GD, s_WE_GD, s_NS_FH,s_WE_FH,s_NS_AC, s_WE_AC, Weight): #the threshold of West-East and North-South directions
    ...
    while traci.simulation.getMinExpectedNumber() > 0:
        ...
        ####Here we simulate the attacking of one sensor U1
        #sum2_I_IK_0 = 0
        #queue_I_IK_0 = sum1_I_IK_0 - sum2_I_IK_0 + 1
        ####Here we simulate the attacking of one sensor V1
        #sum1_I_IK_0 = 0
        #queue_I_IK_0 = sum1_I_IK_0 - sum2_I_IK_0 + 1

        [queue_I_IK_1, id_V2, id_U2, sum1_I_IK_1, sum2_I_IK_1] = vehicle_number("V2", "U2", id_V2, id_U2, sum1_I_IK_1, sum2_I_IK_1)           
        ##### Here we simulate the attacking of one sensor U2
        #sum2_I_IK_1 = 0
        #queue_I_IK_1 = sum1_I_IK_1 - sum2_I_IK_1 + 1
        #### Here we simulate the attacking of one sensor V2
        #sum1_I_IK_1 = 0
        #queue_I_IK_1 = sum1_I_IK_1 - sum2_I_IK_1 + 1
        queue_I_IK = queue_I_IK_0 + queue_I_IK_1 #the total queue length of lane I_IK
        ...
        ##### Here we simulate the attacking of one sensor S1
        sum2_K_IK=0
        queue_K_IK = sum1_K_IK - sum2_K_IK
        ...
        ####Here we simulate the attacking of one sensor V3
        #sum1_IK_LJ_0 = 0
        #queue_IK_LJ_0 = sum1_IK_LJ_0 - sum2_IK_LJ_0 + 1
        ####Here we simulate the attacking of one sensor U3
        #sum2_IK_LJ_0 = 0
        #queue_IK_LJ_0 = sum1_IK_LJ_0 - sum2_IK_LJ_0 + 1

        [queue_IK_LJ_1, id_V4, id_U4, sum1_IK_LJ_1, sum2_IK_LJ_1] = vehicle_number("V4", "U4", id_V4, id_U4, sum1_IK_LJ_1, sum2_IK_LJ_1) 
        ####Here we simulate the attacking of one sensor V4
        #sum1_IK_LJ_1 = 0
        #queue_IK_LJ_1 = sum1_IK_LJ_1 - sum2_IK_LJ_1 + 1
        ####Here we simulate the attacking of one sensor U4
        #sum2_IK_LJ_1 = 0
        #queue_IK_LJ_1 = sum2_IK_LJ_1 - sum2_IK_LJ_1 + 1        
        ...
        ####Here we simulate the attacking of one sensor T3
        #sum1_L_LJ = 0
        #queue_L_LJ = sum1_L_LJ - sum2_L_LJ + 1
        ####Here we simulate the attacking of one sensor S3
        #sum2_L_LJ = 0
        #queue_L_LJ = sum1_L_LJ - sum2_L_LJ + 1       
        ...
        ####Here we simulate the attacking of one sensor V5
        #sum1_G_GD_0 = 0
        #queue_G_GD_0 = sum1_G_GD_0 - sum2_G_GD_0 + 1
        ####Here we simulate the attacking of one sensor U5
        #sum2_G_GD_0 = 0
        #queue_G_GD_0 = sum1_G_GD_0 - sum2_G_GD_0 + 1 

        [queue_G_GD_1, id_V6, id_U6, sum1_G_GD_1, sum2_G_GD_1] = vehicle_number("V6", "U6", id_V6, id_U6, sum1_G_GD_1, sum2_G_GD_1)
         ####Here we simulate the attacking of one sensor V6
        #sum1_G_GD_1 = 0
        #queue_G_GD_1 = sum1_G_GD_1 - sum2_G_GD_1 + 1
        ####Here we simulate the attacking of one sensor U4
        #sum2_G_GD_1 = 0
        #queue_G_GD_1 = sum1_G_GD_1 - sum2_G_GD_1 + 1            
        ...
        ####Here we simulate the attacking of one sensor T2
        #sum1_IK_GD = 0
        #queue_IK_GD = sum1_IK_GD - sum2_IK_GD + 1
        ####Here we simulate the attacking of one sensor S2
        #sum2_IK_GD = 0
        #queue_IK_GD = sum1_IK_GD - sum2_IK_GD + 1
        ...
        ####Here we simulate the attacking of one sensor V7
        #sum1_GD_FH_0 = 0
        #queue_GD_FH_0 = sum1_GD_FH_0 - sum2_GD_FH_0 + 1
        ####Here we simulate the attacking of one sensor U7
        #sum2_GD_FH_0 = 0
        #queue_GD_FH_0 = sum1_GD_FH_0 - sum2_GD_FH_0 + 1

        [queue_GD_FH_1, id_V8, id_U8, sum1_GD_FH_1, sum2_GD_FH_1] = vehicle_number("V8", "U8", id_V8, id_U8, sum1_GD_FH_1, sum2_GD_FH_1) 
        ####Here we simulate the attacking of one sensor V8
        #sum1_GD_FH_1 = 0
        #queue_GD_FH_1 = sum1_GD_FH_1 - sum2_GD_FH_1 + 1
        ####Here we simulate the attacking of one sensor U8
        #sum2_GD_FH_0 = 0
        #queue_GD_FH_1 = sum1_GD_FH_1 - sum2_GD_FH_1 + 1
        ...
        ####Here we simulate the attacking of one sensor T4
        #sum1_LJ_FH = 0
        #queue_LJ_FH = sum1_LJ_FH - sum2_LJ_FH + 1
        ####Here we simulate the attacking of one sensor S4
        #sum2_LJ_FH = 0
        #queue_LJ_FH = sum1_LJ_FH - sum2_LJ_FH + 1
        ...
        ####Here we simulate the attacking of one sensor V9
        #sum1_A_AC_0 = 0
        #queue_A_AC_0 = sum1_A_AC_0 - sum2_A_AC_0 + 1
        ####Here we simulate the attacking of one sensor U9
        #sum2_A_AC_0 = 0
        #queue_A_AC_0 = sum1_A_AC_0 - sum2_A_AC_0 + 1

        [queue_A_AC_1, id_V10, id_U10, sum1_A_AC_1, sum2_A_AC_1] = vehicle_number("V10", "U10", id_V10, id_U10, sum1_A_AC_1, sum2_A_AC_1) 
        ####Here we simulate the attacking of one sensor V10
        #sum1_A_AC_1 = 0
        #queue_A_AC_1 = sum1_A_AC_1 - sum2_A_AC_1 + 1
        ####Here we simulate the attacking of one sensor U10
        #sum2_A_AC_1 = 0
        #queue_A_AC_1 = sum1_A_AC_1 - sum2_A_AC_1 + 1         
        ...
        ####Here we simulate the attacking of one sensor T5
        #sum1_E_AC_0 = 0
        #queue_E_AC_0 = sum1_E_AC_0 - sum2_E_AC_0 + 1
        ####Here we simulate the attacking of one sensor S5
        #sum2_E_AC_0 = 0
        #queue_E_AC_0 = sum1_E_AC_0 - sum2_E_AC_0 + 1

        [queue_E_AC_1, id_T6, id_S6, sum1_E_AC_1, sum2_E_AC_1] = vehicle_number("T6", "S6", id_T6, id_S6, sum1_E_AC_1, sum2_E_AC_1) 
        ####Here we simulate the attacking of one sensor T6
        #sum1_E_AC_1 = 0
        #queue_E_AC_1 = sum1_E_AC_1 - sum2_E_AC_1 + 1
        ####Here we simulate the attacking of one sensor S6
        #sum2_E_AC_1 = 0
        #queue_E_AC_1 = sum1_E_AC_1 - sum2_E_AC_1 + 1          
...
if __name__ == "__main__":
    ...
    s_NS_IK=4 
    s_WE_IK=6 #the threshold of North-South and West-East direction for intersection IK

    s_NS_LJ=4 
    s_WE_LJ=6 #the threshold of North-South and West-East direction for intersection LJ

    s_NS_GD=4 
    s_WE_GD=2 #the threshold of North-South and West-East direction for intersection GD

    s_NS_FH=4 
    s_WE_FH=6 #the threshold of North-South and West-East direction for intersection FH

    s_NS_AC=5
    s_WE_AC=9 #the threshold of North-South and West-East direction for intersection IK
    
    Weight = 1 #the weight of firetrucks, it can be changed
    ...
    s_NS_IK=4 
    s_WE_IK=4 #the threshold of North-South and West-East direction for intersection IK

    s_NS_LJ=4 
    s_WE_LJ=4 #the threshold of North-South and West-East direction for intersection LJ

    s_NS_GD=4 
    s_WE_GD=4 #the threshold of North-South and West-East direction for intersection GD

    s_NS_FH=4 
    s_WE_FH=4 #the threshold of North-South and West-East direction for intersection FH

    s_NS_AC=4
    s_WE_AC=4 #the threshold of North-South and West-East direction for intersection IK
